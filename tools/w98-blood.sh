#!/usr/bin/env bash
# w98-blood.sh -- Blood (the 1997 DOS Build-engine game) in a Windows 98 DOS
...
#     RUN_SECS= (100), FRESH= (1: a fresh raw copy every run -- a DOS box
#     does not answer the power button, so the copy is left dirty)
