...
with later work by David Bolton (2010) — the bank MuseScore 0.9.6–1.3
shipped and Debian packages as `timgm6mb-soundfont`. This copy is byte
...
- **Its licence is ours.** The author states the samples are his own or
  public domain / GPL. A bank whose sample provenance is uncertain — the
  larger, better-sounding GeneralUser GS says its own is only "as good as
  the information the original sources gave" — is one to point the user
  at, not to put in a GPL package.
