...
- **Step 6a — the install layout and the Linux package landed**
  ...
  **Not done here:** the Flatpak (needs `flatpak-builder`, not installed
  ...
  links ~93 of them (gnutls, glib, … — the displays, the six host audio
  backends, the spare network and block drivers and brlapi all went on
  2026-09-07, taking 82 with them) and the package ships none, so
