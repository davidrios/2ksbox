...
| XP display driver (doc 15) | `d3dpt-vga`, register set v5. DirectDraw, a DirectX 9 DDI with shader model 3.0 to `d3d9.dll` (M16: the face, the tokens, the DX9 formats, mip generation, instancing) and a DirectX 8 DDI with hardware T&L, shaders 1.x, palettes, colour keys, VRAM buffers, 16 streams, cube / volume textures, MSAA, gamma. FIFA 2000, Max Payne, Vice City, Moto Racer and Diablo play. |
